  ...
  <Layout>
    ...
    <section>
      <div className="hero">
        ...
        <div className="hero-overlay">
          ...
          <Link className="hero-link" to="/order-online/">
            place an order
          </Link>
          <div className="mobile-delivery-providers">
            ...
            <div className="link-button">
              <img
                style={{ width: `80%`, marginLeft: `2em`, marginTop: `0.25em` }}
                src={doordash}
                alt="logo"
              />
            </div>
            <div className="link-button">
              <img
                style={{ width: `60%`, marginLeft: `2em`, marginTop: `0.25em` }}
                src={uber}
                alt="logo"
              />
            </div>
    ...
    <section>
      <div className="info-section">
        <div className="info-section-top">
          <h3>[subheading]</h3>
          <p>
            Welcome to <span style={{ color: `#DF2332` }}>[Restaurant]</span>
          </p>
        </div>
    ...
    <section>
      <div style={{ backgroundColor: `#000` }} className="info-section">
        <div className="info-section-top">
          <p style={{ color: `#fff` }}>
            From our kitchen with <span style={{ color: `#DF2332` }}>love</span>
          </p>
        </div>
        <div className="info-section-bottom">
          <div className="info-section-bottom-left">
          ...
          <div className="info-section-bottom-right">
            <p style={{ color: `#fff` }}>
              <span style={{ fontSize: `1.5rem`, fontWeight: `bold` }}>
                We believe in the wholesome, healthful benefits
              </span>
              <br />
              Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
              eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut
    ...
    <section>
      <div className="info-section">
        <div className="info-section-top">
          <p>
            We would love to have <span style={{ color: `#DF2332` }}>you</span>{" "}
            over
          </p>
        </div>
        <div className="info-section-bottom">
          <div className="info-section-bottom-left">
            ...
            <p>
              Best yet, many of our menu items fall under 700 calories and can
              be customized to accommodate low-fat, low-carb, high protein diets
              Best yet, many of our menu items fall under 700 calories and can
              be customized to accommodate low-fat, low-carb, high protein diets
            </p>
            <a href="https://davidvelez.io" className="google-link">
    ...
    <section>
      <div className="social-banner">
        <div className="social-banner-left">
          <p>Follow and like us on social</p>
        </div>
    ...
    <section>
      <div style={{ backgroundColor: `#DF2332` }} className="info-section">
        <div className="info-section-top">
          <p>
            Our customers <span style={{ color: `#fff` }}>love us</span> and so
            will you
          </p>
        </div>
        <div className="info-section-bottom">
